...
const HeaderMain = () => {
   ...
   const favoriteCount = photos.length > 0 ? photos.filter((item) => item.isFavorite === true).length : 0;
      ...
      <div className="p-4 bg-white shadow-md flex items-center justify-center">
         ...
         <div className="ml-auto mr-5 flex items-center gap-5">
            <span className="relative w-8">
               <svg className="max-w-full" width="44" height="41" viewBox="0 0 44 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <ellipse cx="20.9584" cy="37.7083" rx="3.125" ry="3.125" fill="#292D32" />
                  <circle cx="33.4584" cy="37.7083" r="3.125" fill="#292D32" />
                  <path d="M5.33333 13.75L3.25 13.75" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" />
                  <path d="M7.41671 26.25L5.33337 26.25" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" />
                  <path d="M7.41669 20H1.16669" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" />
                  <path
            ...
            <span className="relative w-8">
               <svg className="max-w-full" width="42" height="38" viewBox="0 0 42 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
